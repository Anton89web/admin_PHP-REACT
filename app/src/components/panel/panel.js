...
const Panel = ({virtualDomState}) => {
    return (
        <div className="panel">
          ...
          {virtualDomState ? <button className="uk-button uk-button-primary uk-margin-small-right" uk-toggle="target: #modal-meta"> Редактировать Meta</button> : false}
